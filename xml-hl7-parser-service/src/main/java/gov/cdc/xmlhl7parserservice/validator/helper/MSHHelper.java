...
public class MSHHelper {
  ...
  public void validateMSHFields(MSH msh) throws HL7Exception {
    ...
    validator.validateField(
        "MSH-3.NamespaceID", msh.getSendingApplication().getNamespaceID().getValue(), false, 0, 20);
    validator.validateField(
        "MSH-3.UniversalID", msh.getSendingApplication().getUniversalID().getValue(), true, 0, 199);
    validator.validateField(
        "MSH-3.UniversalIDType",
    ...
    validator.validateField(
        "MSH-4.NamespaceID", msh.getSendingFacility().getNamespaceID().getValue(), false, 0, 20);
    validator.validateField(
        "MSH-4.UniversalID", msh.getSendingFacility().getUniversalID().getValue(), true, 0, 199);
    validator.validateField(
        "MSH-4.UniversalIDType",
    ...
    validator.validateField(
        "MSH-6.NamespaceID", msh.getReceivingFacility().getNamespaceID().getValue(), false, 0, 20);
    validator.validateField(
        "MSH-6.UniversalID", msh.getReceivingFacility().getUniversalID().getValue(), true, 0, 199);
    validator.validateField(
        "MSH-6.UniversalIDType",
    ...
    validator.validateField(
        "MSH-16", msh.getApplicationAcknowledgmentType().getValue(), false, 0, 2);
    ...
    validator.validateField(
        "MSH-20", msh.getAlternateCharacterSetHandlingScheme().getValue(), false, 0, 20);
