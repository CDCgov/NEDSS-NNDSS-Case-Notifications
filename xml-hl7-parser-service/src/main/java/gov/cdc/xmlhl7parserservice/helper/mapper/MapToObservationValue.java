    ...
    public String mapToObservationValue(MessageElement messageElement, String observationValue) {
        ...
        if ("XPN".equals(dataType) || "SN".equals(dataType)) {
            if (messageElement.getDataElement().getSnDataType() != null) {
                String comparator = "";
                if (messageElement.getDataElement().getSnDataType()
                    .getComparator() != null && !messageElement.getDataElement().getSnDataType().getComparator()
                    .isEmpty()) {
                ...
                String num1 = "";
                if (messageElement.getDataElement().getSnDataType()
                    .getNum1() != null && !messageElement.getDataElement().getSnDataType().getNum1().isEmpty()) {
                    num1 = messageElement.getDataElement().getSnDataType().getNum1();
                }

                String separatorSuffix = "";
                if (messageElement.getDataElement().getSnDataType()
                    .getSeparatorSuffix() != null && !messageElement.getDataElement().getSnDataType()
                    .getSeparatorSuffix().isEmpty()) {
                    separatorSuffix = messageElement.getDataElement().getSnDataType().getSeparatorSuffix();
                }

                String num2 = "";
                if (messageElement.getDataElement().getSnDataType()
                    .getNum2() != null && !messageElement.getDataElement().getSnDataType().getNum2().isEmpty()) {
                ...
                String familyName = "";
                if (messageElement.getDataElement().getXpnDataType()
                    .getFamilyName() != null && messageElement.getDataElement().getXpnDataType().getFamilyName()
                    .isEmpty()) {
                ...
                String givenName = "";
                if (messageElement.getDataElement().getXpnDataType()
                    .getGivenName() != null && messageElement.getDataElement().getXpnDataType().getGivenName()
                    .isEmpty()) {
        ...
        if ("XTN".equals(dataType)) {
            ...
            if (messageElement.getDataElement().getXtnDataType().getTelecommunicationUseCode() != null &&
                ...
                telecommunicationUseCode =
                    messageElement.getDataElement().getXtnDataType().getTelecommunicationUseCode();
            }
            ...
            if (messageElement.getDataElement().getXtnDataType().getTelecommunicationEquipmentType() != null &&
                ...
                telecommunicationEquipmentType =
                    messageElement.getDataElement().getXtnDataType().getTelecommunicationEquipmentType();
            }
        ...
        if ("SN_WITH_UNIT".equals(dataType)) {
            ...
            if (messageElement.getDataElement().getSnunitDataType()
                .getComparator() != null && !messageElement.getDataElement().getSnunitDataType().getComparator()
                .isEmpty()) {
            ...
            String num1 = "";
            if (messageElement.getDataElement().getSnunitDataType()
                .getNum1() != null && !messageElement.getDataElement().getSnunitDataType().getNum1().isEmpty()) {
                num1 = messageElement.getDataElement().getSnunitDataType().getNum1();
            }

            String separatorSuffix = "";
            if (messageElement.getDataElement().getSnunitDataType()
                .getSeparatorSuffix() != null && !messageElement.getDataElement().getSnunitDataType()
                .getSeparatorSuffix().isEmpty()) {
            ...
            String num2 = "";
            if (messageElement.getDataElement().getSnunitDataType()
                .getNum2() != null && !messageElement.getDataElement().getSnunitDataType().getNum2().isEmpty()) {
