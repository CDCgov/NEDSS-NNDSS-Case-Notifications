...
public class DeadLetterController {
  ...
  public ResponseEntity<Page<CaseNotificationDlt>> getDltsByTimestampRange(
    ...
    try {
      ...
      Page<CaseNotificationDlt> results =
          dltService.getDltsBetweenWithPagination(start, end, page, size);
  ...
  @Operation(
      ...
      description =
          "Reprocesses a previously dead-lettered message using the given payload and UUID.",
      parameters = {
        @Parameter(
            in = ParameterIn.HEADER,
            name = "clientid",
  ...
  public ResponseEntity<Void> reprocessCaseNotification(
      @RequestBody String payload, @PathVariable("uuid") String uuid) {
    try {
