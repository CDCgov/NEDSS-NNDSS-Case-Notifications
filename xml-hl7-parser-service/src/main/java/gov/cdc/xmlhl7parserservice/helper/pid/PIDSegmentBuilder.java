    ...
    public void processPIDFields(MessageElement messageElement, PID pid) throws DataTypeException {
        ...
        if (pidField.startsWith("PID-3.1")) {
            if (messageElement.getDataElement().getQuestionDataTypeNND().equals("CX")) {
                pid.getPid3_PatientIdentifierList(0).getIDNumber()
            ...
            pid.getPid3_PatientIdentifierList(0).getAssigningAuthority().getNamespaceID()
                .setValue(messageElement.getDataElement().getIsDataType().getIsCodedValue());
        } else if (pidField.startsWith("PID-3.4.2")) {
            pid.getPid3_PatientIdentifierList(0).getAssigningAuthority().getUniversalID()
                .setValue(messageElement.getDataElement().getStDataType().getStringData());
        } else if (pidField.startsWith("PID-3.4.3")) {
            pid.getPid3_PatientIdentifierList(0).getAssigningAuthority().getUniversalIDType()
            ...
            if (pid.getPid5_PatientName(0).getNameTypeCode() != null) {
                ...
                pid.getPid5_PatientName(1).getNameTypeCode()
                    .setValue(messageElement.getDataElement().getIdDataType().getIdCodedValue());
            } else {
                pid.getPid5_PatientName(0).getNameTypeCode()
                    .setValue(messageElement.getDataElement().getIdDataType().getIdCodedValue());
            }
        } else if (pidField.startsWith("PID-7.0")) {
            pidFieldValue = messageElement.getDataElement().getTsDataType().getTime().toString();
            String dateFormat =
                dateFormatUtil.formatDate(pidFieldValue, questionDataTypeNND, questionIdentifierNND, "PID-7");
            ...
            pid.getPid11_PatientAddress(messageState.getZipcodeIndex()).getZipOrPostalCode()
                .setValue(messageElement.getDataElement().getStDataType().getStringData());
            messageState.setZipcodeIndex(messageState.getZipcodeIndex() + 1);
        } else if (pidField.startsWith("PID-11.6")) {
            pid.getPid11_PatientAddress(messageState.getCountryIndex()).getCountry()
                .setValue(messageElement.getDataElement().getIdDataType().getIdCodedValue());
            messageState.setCountryIndex(messageState.getCountryIndex() + 1);
        } else if (pidField.startsWith("PID-11.7")) {
            pid.getPid11_PatientAddress(messageState.getAddressTypeIndex()).getAddressType()
                .setValue(messageElement.getDataElement().getIdDataType().getIdCodedValue());
            messageState.setAddressTypeIndex(messageState.getAddressTypeIndex() + 1);
        } else if (pidField.startsWith("PID-11.9")) {
            pid.getPid11_PatientAddress(messageState.getCountryIndex()).getCountyParishCode()
                .setValue(messageElement.getDataElement().getIsDataType().getIsCodedValue());
            messageState.setCountryIndex(messageState.getCountryIndex() + 1);
        } else if (pidField.startsWith("PID-11.10")) {
            pid.getPid11_PatientAddress(0).getCensusTract()
                .setValue(messageElement.getDataElement().getIsDataType().getIsCodedValue());
        } else if (pidField.startsWith("PID-15.0")) {
            pid.getPid15_PrimaryLanguage().getIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValue());
            pid.getPid15_PrimaryLanguage().getText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueDescription());
            pid.getPid15_PrimaryLanguage().getNameOfCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueCodingSystem());
            pid.getPid15_PrimaryLanguage().getAlternateIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValue());
            pid.getPid15_PrimaryLanguage().getAlternateText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueDescription());
            ...
            pid.getPid16_MaritalStatus().getIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValue());
            pid.getPid16_MaritalStatus().getText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueDescription());
            pid.getPid16_MaritalStatus().getNameOfCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueCodingSystem());
            pid.getPid16_MaritalStatus().getAlternateIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValue());
            pid.getPid16_MaritalStatus().getAlternateText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueDescription());
            pid.getPid16_MaritalStatus().getNameOfAlternateCodingSystem()
            ...
            pid.getPid17_Religion().getIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValue());
            pid.getPid17_Religion().getText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueDescription());
            pid.getPid17_Religion().getNameOfCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueCodingSystem());
            pid.getPid17_Religion().getAlternateIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValue());
            pid.getPid17_Religion().getAlternateText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueDescription());
            pid.getPid17_Religion().getNameOfAlternateCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueCodingSystem());
        } else if (pidField.startsWith("PID-22.0")) {
            pid.getPid22_EthnicGroup(0).getIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValue());
            pid.getPid22_EthnicGroup(0).getText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueDescription());
            pid.getPid22_EthnicGroup(0).getNameOfCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueCodingSystem());
            pid.getPid22_EthnicGroup(0).getAlternateIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValue());
            pid.getPid22_EthnicGroup(0).getAlternateText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueDescription());
            pid.getPid22_EthnicGroup(0).getNameOfAlternateCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueCodingSystem());
            ...
            pid.getPid26_Citizenship(citizenshipTypeIndex).getIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValue());
            pid.getPid26_Citizenship(citizenshipTypeIndex).getText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueDescription());
            pid.getPid26_Citizenship(citizenshipTypeIndex).getNameOfCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueCodingSystem());
            pid.getPid26_Citizenship(citizenshipTypeIndex).getAlternateIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValue());
            pid.getPid26_Citizenship(citizenshipTypeIndex).getAlternateText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueDescription());
            pid.getPid26_Citizenship(citizenshipTypeIndex).getNameOfAlternateCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueCodingSystem());
            messageState.setCitizenshipTypeIndex(citizenshipTypeIndex + 1);
        } else if (pidField.startsWith("PID-27.0")) {
            pid.getPid27_VeteransMilitaryStatus().getIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValue());
            pid.getPid27_VeteransMilitaryStatus().getText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueDescription());
            pid.getPid27_VeteransMilitaryStatus().getNameOfCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueCodingSystem());
            pid.getPid27_VeteransMilitaryStatus().getAlternateIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValue());
            pid.getPid27_VeteransMilitaryStatus().getAlternateText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueDescription());
            pid.getPid27_VeteransMilitaryStatus().getNameOfAlternateCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueCodingSystem());
        } else if (pidField.startsWith("PID-29.0")) {
            pidFieldValue = messageElement.getDataElement().getTsDataType().getTime().toString().trim();
            String dateFormat =
                dateFormatUtil.formatDate(pidFieldValue, questionDataTypeNND, questionIdentifierNND, "PID-29.0");
            ...
            String dateFormat =
                dateFormatUtil.formatDate(pidFieldValue, questionDataTypeNND, questionIdentifierNND, "PID-33.0");
            pid.getPid33_LastUpdateDateTime().getTime().setValue(dateFormat);
        } else if (pidField.startsWith("PID-34.1")) {
            pid.getPid34_LastUpdateFacility().getNamespaceID()
                .setValue(messageElement.getDataElement().getIsDataType().getIsCodedValue());
        } else if (pidField.startsWith("PID-34.2")) {
            pid.getPid34_LastUpdateFacility().getUniversalID()
                .setValue(messageElement.getDataElement().getStDataType().getStringData());
        } else if (pidField.startsWith("PID-34.3")) {
            pid.getPid34_LastUpdateFacility().getUniversalIDType()
                .setValue(messageElement.getDataElement().getIdDataType().getIdCodedValue());
        } else if (pidField.startsWith("PID-35")) {
            pid.getPid35_SpeciesCode().getIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValue());
            pid.getPid35_SpeciesCode().getText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueDescription());
            pid.getPid35_SpeciesCode().getNameOfCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueCodingSystem());
            pid.getPid35_SpeciesCode().getAlternateIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValue());
            pid.getPid35_SpeciesCode().getAlternateText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueDescription());
            pid.getPid35_SpeciesCode().getNameOfAlternateCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueCodingSystem());
        } else if (pidField.startsWith("PID-36")) {
            pid.getPid36_BreedCode().getIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValue());
            pid.getPid36_BreedCode().getText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueDescription());
            pid.getPid36_BreedCode().getNameOfCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueCodingSystem());
            pid.getPid36_BreedCode().getAlternateIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValue());
            pid.getPid36_BreedCode().getAlternateText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueDescription());
            pid.getPid36_BreedCode().getNameOfAlternateCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueCodingSystem());
            ...
            pid.getPid38_ProductionClassCode().getIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValue());
            pid.getPid38_ProductionClassCode().getText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueDescription());
            pid.getPid38_ProductionClassCode().getNameOfCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeCodedValueCodingSystem());
            pid.getPid38_ProductionClassCode().getAlternateIdentifier()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValue());
            pid.getPid38_ProductionClassCode().getAlternateText()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueDescription());
            pid.getPid38_ProductionClassCode().getNameOfAlternateCodingSystem()
                .setValue(messageElement.getDataElement().getCeDataType().getCeLocalCodedValueCodingSystem());
        }
    }
} 
