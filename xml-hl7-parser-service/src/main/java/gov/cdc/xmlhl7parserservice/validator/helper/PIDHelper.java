...
public class PIDHelper {
    ...
    public void validatePIDFields(PID pid) throws HL7Exception {
        validator.validateField("PID-3.IDNumber", pid.getPatientIdentifierList(0).getIDNumber().getValue(), true, 1,
            15);
        ...
        validator.validateField("PID-3.AssigningAuthority.UniversalID",
            pid.getPatientIdentifierList(0).getAssigningAuthority().getUniversalID().getValue(), true, 0, 199);
        validator.validateField("PID-3.AssigningAuthority.UniversalIDType",
            pid.getPatientIdentifierList(0).getAssigningAuthority().getUniversalIDType().getValue(), true, 0, 6);
