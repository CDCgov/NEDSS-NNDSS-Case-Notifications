...
public class NK1Helper {
  ...
  public void validateNK1Fields(NK1 nk1) throws HL7Exception {
    ...
    validator.validateField(
        "NK1-10", nk1.getNextOfKinAssociatedPartiesJobTitle().getValue(), false, 0, 250);
    validator.validateField(
        "NK1-11", nk1.getNextOfKinAssociatedPartiesJobCodeClass().toString(), false, 0, 250);
    validator.validateField(
        "NK1-12", nk1.getNextOfKinAssociatedPartiesEmployeeNumber().toString(), false, 0, 250);
    ...
    validator.validateField(
        "NK1-31", nk1.getContactPersonSTelephoneNumber(0).toString(), false, 0, 250);
    validator.validateField("NK1-32", nk1.getContactPersonSAddress(0).toString(), false, 0, 250);
    //        validator.validateField("NK1-33", nk1.getnextofkinassociatedpartiesI(0).toString(),
    // false, 0, 250);
    ...
    validator.validateField(
        "NK1-37", nk1.getContactPersonSocialSecurityNumber().getValue(), false, 0, 250);
