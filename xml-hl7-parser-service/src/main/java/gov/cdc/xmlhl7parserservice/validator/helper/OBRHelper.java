...
public class OBRHelper {
  ...
  public void validateOBRFields(OBR obr) throws HL7Exception {
    ...
    validator.validateField(
        "OBR-7", obr.getObservationDateTime().getTime().getValue(), false, 0, 26);
    validator.validateField(
        "OBR-8", obr.getObservationEndDateTime().getTime().getValue(), false, 0, 26);
    ...
    validator.validateField(
        "OBR-13", obr.getRelevantClinicalInformation().getValue(), false, 0, 300);
    validator.validateField(
        "OBR-14", obr.getSpecimenReceivedDateTime().getTime().getValue(), false, 0, 26);
    ...
    validator.validateField(
        "OBR-22", obr.getResultsRptStatusChngDateTime().getTime().getValue(), false, 0, 26);
    ...
    validator.validateField(
        "OBR-32", obr.getPrincipalResultInterpreter().toString(), false, 0, 250);
    validator.validateField(
        "OBR-33", obr.getAssistantResultInterpreter(0).toString(), false, 0, 250);
    ...
    validator.validateField(
        "OBR-36", obr.getScheduledDateTime().getTime().getValue(), false, 0, 26);
    validator.validateField("OBR-37", obr.getNumberOfSampleContainers().getValue(), false, 0, 4);
    validator.validateField(
        "OBR-38", obr.getTransportLogisticsOfCollectedSample(0).toString(), false, 0, 250);
    validator.validateField("OBR-39", obr.getCollectorSComment(0).toString(), false, 0, 250);
    validator.validateField(
        "OBR-40", obr.getTransportArrangementResponsibility().toString(), false, 0, 250);
    ...
    validator.validateField(
        "OBR-43", obr.getPlannedPatientTransportComment(0).toString(), false, 0, 250);
    ...
    validator.validateField(
        "OBR-46", obr.getPlacerSupplementalServiceInformation(0).toString(), false, 0, 250);
    validator.validateField(
        "OBR-47", obr.getFillerSupplementalServiceInformation(0).toString(), false, 0, 250);
    validator.validateField(
        "OBR-48", obr.getMedicallyNecessaryDuplicateProcedureReason().toString(), false, 0, 250);
