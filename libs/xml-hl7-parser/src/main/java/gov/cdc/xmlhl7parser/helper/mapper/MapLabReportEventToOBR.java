package gov.cdc.xmlhl7parser.helper.mapper;
...
import gov.cdc.xmlhl7parser.model.ResultMethod;
...
public class MapLabReportEventToOBR {
  ...
  public MapLabReportEventToOBR(
      MapToEIType mapToEIType,
      MapToCEType mapToCEType,
      MapToCWEType mapToCWEType,
      MapToTS18DataType mapToTS18DataType,
      MapResultedTestToOBX mapResultedTestToOBX,
      MapToDTM18 mapToDTM18) {
  ...
  public void mapLabReportEventToOBR(
      NBSNNDIntermediaryMessage nbsnndIntermediaryMessage,
      LabReportEvent labReportEvent,
      int obrCounter,
      int labObrCounter,
      String messageType,
      int i,
      ...
      if (hl7Field.startsWith("OBR-")) {
        ...
        if (dataElement.startsWith("1.")) {
          ...
          mapToEIType.mapToEIType(
              ...
              oruMessage
                  .getPATIENT_RESULT()
                  .getORDER_OBSERVATION(obrCounter)
                  .getOBR()
    ...
    if (parentLink.getObservationValue() != null && !parentLink.getObservationValue().isEmpty()) {
      ...
      parentObservationIdentifier
          ...
          .setValue(parentLink.getNameOfCodingSystem());
      ...
      parentObservationIdentifier
          ...
          .setValue(parentLink.getAlternateIdentifier());
      ...
      oruMessage
          ...
          .setValue(parentLink.getObservationSubID());
      oruMessage
          .getPATIENT_RESULT()
          .getORDER_OBSERVATION(obrCounter)
          .getOBR()
          ...
          .setValue(parentLink.getObservationValue());
    }
    ...
    for (int j = 0; j < resultedTestList.size(); j++) {
      ...
      for (int k = previousCounter;
          k
              < oruMessage
                  .getPATIENT_RESULT()
                  .getORDER_OBSERVATION(obrCounter)
                  .getOBSERVATION(labSubCounter)
                  .getOBX()
                  .numFields();
          k++) {
        if (oruMessage
        ...
        if (cachedOBX3data != null
            && !cachedOBX3data.isEmpty()
            && cachedOBX3data.contains(identifier + ":")) {
          ...
          if (start == 0) {
            ...
            int lookaheadLength =
                Math.min(
                    cachedOBX3data.length() - contTest, identifier.length() + 6); // safe bounds
        ...
        if (referenceRangeFrom.isEmpty() && !referenceRangeTo.isEmpty()) {
          oruMessage
              ...
              .getOBX()
              .getReferencesRange()
              .setValue(referenceRangeFrom + "-" + referenceRangeTo);
        ...
        oruMessage
            ...
            .getOBX()
            .getObservationSubID()
            .setValue(Integer.toString(obxSubidCounter));
        String cweOBX =
            oruMessage
                .getPATIENT_RESULT()
                .getORDER_OBSERVATION(obrCounter)
        ...
        if ("CWE".equals(cweOBX) || "CE".equals(ceOBX)) {
          ...
          parentLinkOBX.setNameOfCodingSystem(
              observationIdentifier.getNameOfCodingSystem().getValue());
  ...
  void mapToSusceptibilityOBX(
      NBSNNDIntermediaryMessage nbsnndIntermediaryMessage,
      LabReportEvent.ResultedTest resultedTest,
      int obrCounter,
      int labSubCounter,
      int resultedTestCounter,
      int i,
      String messageType,
      ParentLink parentLink,
      EIElement eiElement,
