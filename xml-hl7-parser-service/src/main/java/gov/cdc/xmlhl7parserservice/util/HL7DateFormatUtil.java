...
public class HL7DateFormatUtil {
  ...
  /**
   * Formats a date value according to HL7 standards based on the segment and field type Uses DataTypeProcessor to
   * handle the actual date formatting based on HL7 standards
   *
   ...
   */
  public String formatDate(String dateValue, String questionDataTypeNND, String questionIdentifierNND,
    String segmentField) {
