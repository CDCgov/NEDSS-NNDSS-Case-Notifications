...
echo "  - Logs:     docker compose logs -f case-notification-service"
echo "  - DB check: SELECT record_status_cd, COUNT(*) FROM CN_transportq_out WHERE notification_local_id LIKE 'NOT-PERF-%' GROUP BY record_status_cd"
