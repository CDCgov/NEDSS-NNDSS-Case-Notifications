...
public class KafkaConsumerConfig {
    ...
    @Value("${spring.kafka.group-id-cn-transport-out}")
...
//        config.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, true); // Manual commit
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactoryDebeziumConsumer() {
